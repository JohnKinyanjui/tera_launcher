...
final Function(int ) onpress;
  ...
  const AppCategory({Key key, this.onpress, this.currentPage}) : super(key: key);
  @override
...
class _AppCategoryState extends State<AppCategory> {
  ...
  Color inactiveColor = Colors.grey[300].withOpacity(0.5);
  ...
  _scrollToTop() {
    _scrollController.animateTo(_scrollController.position.minScrollExtent, duration: Duration(milliseconds: 1000), curve: Curves.ease);
  }
  @override
  void initState() {
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index){
            return AppHolder(
              ...
              child: Icon(getCategoryIcon(index), color: i == index ? activeColor : inactiveColor,),
            );
          },
        ),
    );
